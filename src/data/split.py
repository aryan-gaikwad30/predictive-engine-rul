...
def get_engine_split_ids(
    ...
    # Shuffle and split using local RNG
...
def validate_engine_split(
    ...
    # 3. Exact row preservation: no rows were duplicated or silently removed.
    # Combine the splits and compare against original DataFrame
    ...
    try:
        # Check exact identity (index and values) between original and combined
        ...
        raise ValueError("Exact row preservation failed: rows were altered, duplicated, or lost.")
